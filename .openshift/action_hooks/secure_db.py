#!/usr/bin/env python
# Based on https://github.com/rancavil/django-py3-openshift-quickstart/
import hashlib, os, sqlite3, sys, inspect, random
...
old_keys = { 'PASS': '123456789ABC' }
use_keys = openshift_secure(old_keys)
...
sys.path.append(os.path.dirname(find('settings.py', os.environ['OPENSHIFT_REPO_DIR'])))
import django
django.setup()
